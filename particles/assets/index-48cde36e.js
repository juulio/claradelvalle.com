...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Aa(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:fs(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function ba(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:fs(),fragmentShader:`
...
`].filter(ci).join(`
`)),o=rs(o),o=Na(o,t),o=Fa(o,t),a=rs(a),a=Na(a,t),a=Fa(a,t),o=Oa(o),a=Oa(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(y=`#version 300 es
