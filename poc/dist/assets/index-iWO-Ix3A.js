...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function la(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$r(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ca(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$r(),fragmentShader:`
