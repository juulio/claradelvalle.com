...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ca(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Qr(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function ua(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Qr(),fragmentShader:`
