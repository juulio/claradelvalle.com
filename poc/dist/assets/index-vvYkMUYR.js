...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function aa(){return new yn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Zr(),fragmentShader:`
		...
		`,blending:sn,depthTest:!1,depthWrite:!1})}function oa(){return new yn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Zr(),fragmentShader:`
